...
class Face_Recognition:
    def __init__(self, root):
        ...
        # First image
        img_top = Image.open(r"C:\Users\madhu\OneDrive\Desktop\Projects\Face Recognition Attendance System\college_images\face_detector.jpg")
        img_top = img_top.resize((650, 700), Image.LANCZOS)  # Corrected to Image.LANCZOS
        self.photoimg_top = ImageTk.PhotoImage(img_top)
        f_lbl = Label(self.root, image=self.photoimg_top)
        f_lbl.place(x=5, y=55, width=650, height=700)

        # Second image
        img_bottom = Image.open(r"C:\Users\madhu\OneDrive\Desktop\Projects\Face Recognition Attendance System\college_images\face_detector1.jpeg")
        img_bottom = img_bottom.resize((950, 700), Image.LANCZOS)  # Corrected to Image.LANCZOS
    ...
    def mark_attendance(self,i,r,n,d):
        with open("kiran.csv","r+",newline="\n") as f:
            ...
            if i not in name_list:  # Check only by ID, you can adjust if needed
                now=datetime.now()
    ...
    def face_recog(self):
        ...
        clf = cv2.face.LBPHFaceRecognizer_create()  # Ensure this is correctly imported
